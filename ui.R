...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      menuItem("Map and year analysis", tabName = "map", icon = icon("map")),
      menuItem("Time_series and state analysis", tabName = "Time_series", icon = icon("chart-line")))
  ...
  dashboardBody(
    ...
    tabItems(tabItem(tabName = "map",
                     ...
                     fluidRow(
                             box(htmlOutput("bar6"),width = 4),
                             box(htmlOutput("bar7"),width = 4),
                             box(htmlOutput("bar8"),width = 4)
                             )
                     ),
